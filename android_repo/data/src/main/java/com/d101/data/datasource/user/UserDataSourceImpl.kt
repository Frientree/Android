...
class UserDataSourceImpl @Inject constructor(
    ...
    override suspend fun updateFcmToken(fcmToken: String): Result<Boolean> = runCatching {
        userService.updateFcmToken(UpdateFcmTokenRequest(fcmToken)).getOrThrow().data
    }.fold(
        onSuccess = {
            Result.Success(it)
        },
